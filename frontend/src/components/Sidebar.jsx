  ...
  const nav = (
    <aside className={cn(
      ...
      <div className={cn("flex items-center shrink-0 py-5", collapsed ? "justify-center px-4" : "px-6 gap-2.5")}>
        ...
        {!collapsed && (
          <span className="text-lg font-display font-bold text-sidebar-foreground translate-y-[1px]">Nexterview</span>
        )}
      </div>
    ...
    <>
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-card border-b border-border shrink-0">
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate("/")}>
          ...
          <span className="text-base font-display font-bold text-text translate-y-[1px]">Nexterview</span>
        </div>
